...
lamb_n6_0_3_6_9_12:
	...
	salq	$3,	%r10
	addq	%r10,	%rcx
	movq	$lamb_n6_0_3_6_9_12_13,	(%rcx)
	movq	%rdi,	8(%rcx)
	movq	%rsi,	16(%rcx)
	leaq	0(%rdx, %rdx, 2),	%r10
	salq	$3,	%r10
	...
	salq	$3,	%r10
	addq	%r10,	%rcx
	movq	$lamb_n6_0_3_6_9_12_14,	(%rcx)
	movq	%rdi,	8(%rcx)
	movq	%rsi,	16(%rcx)
	leaq	0(%rdx, %rdx, 2),	%r10
	salq	$3,	%r10
	...
	salq	$3,	%r10
	addq	%r10,	%rcx
	movq	$lamb_n6_0_3_6_9_12_15,	(%rcx)
	movq	%rdi,	8(%rcx)
	movq	%rsi,	16(%rcx)
	leaq	0(%rdx, %rdx, 2),	%r10
	salq	$3,	%r10
...
lamb_n6_0_3_6_9_12_14:
	...
	popq	%r14
	jmp	*%r10
lamb_n6_0_3_6_9_12_15:
	/* PUSH [ACCESS 0] */
	leaq	0(%rdx, %rdx, 2),	%r10
	salq	$3,	%r10
	addq	%r10,	%rcx
	movq	$lamb_n6_0_3_6_9_12_15_16,	(%rcx)
	movq	%rdi,	8(%rcx)
	movq	%rsi,	16(%rcx)
	leaq	0(%rdx, %rdx, 2),	%r10
	salq	$3,	%r10
	...
	salq	$3,	%r10
	addq	%r10,	%rcx
	movq	$lamb_n6_0_3_6_9_12_15_17,	(%rcx)
	movq	%rdi,	8(%rcx)
	movq	%rsi,	16(%rcx)
	leaq	0(%rdx, %rdx, 2),	%r10
	salq	$3,	%r10
